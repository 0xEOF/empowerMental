...
export const metadata: Metadata = {
  ...
  description: 'Professional counseling and therapeutic support for individuals, teens, couples and families. Many years of experience providing compassionate, evidence-based mental health services.',
